...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <h1>${variables.name == null ? "" : variables.name} ${variables.lastname == null ? "" : variables.lastname}</h1>
          <h2>${variables.role == null ? "" : variables.role}</h2>
          <h3>${variables.country == null ? "" : variables.country}, ${variables.city == null ? "" : variables.city}</h3>
